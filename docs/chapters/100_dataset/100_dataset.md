...
> - **Prerequisites:** [01 · What Is a CTA Strategy](../../01_what_is_cta/01_what_is_cta.md).
...
(Definition, [01](../../01_what_is_cta/01_what_is_cta.md)); this dataset substitutes ETFs so that the mechanics can be
studied without contract-roll handling. The consequence is that shorting is assumed frictionless
and no collateral yield accrues — see [01 § Instruments](../../01_what_is_cta/01_what_is_cta.md).
...
are still unadjusted. Every chapter from [02](../../02_testing_a_signal/02_testing_a_signal.md) onward is exercised on this
...
[← 01](../../01_what_is_cta/01_what_is_cta.md) · [Index](00-index.md)
