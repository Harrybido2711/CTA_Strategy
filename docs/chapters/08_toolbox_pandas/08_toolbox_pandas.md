...
> - **Related:** [02](../../02_testing_a_signal/02_testing_a_signal.md), [05](05-understanding-backtesting.md).
...
grid-searching ([03 § 1](../../03_shaping_the_lookback/03_shaping_the_lookback.md)).
...
Reference chapter — no next step. Used by [02 · Signals](../../02_testing_a_signal/02_testing_a_signal.md) and
