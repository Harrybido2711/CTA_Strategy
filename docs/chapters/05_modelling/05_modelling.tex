...
many times. Cut the training history into short segments, put the same train--validation--test
frame on the first few of them, and slide that frame forward one segment per iteration until it
reaches the end of the training set. Each rung is a complete train--validation--test cycle in
miniature, and there are as many of them as the history allows.
