...
|---|---|---|---|
| CTA (Commodity Trading Advisor) | 商品交易顾问 | Systematic strategy trading futures across asset classes; not limited to commodities | [01](../../01_what_is_cta/01_what_is_cta.md) |
| Absolute return | 绝对收益 | Return target independent of market direction | [01](../../01_what_is_cta/01_what_is_cta.md) |
| Long position | 多头 | Buy low, sell higher | [01](../../01_what_is_cta/01_what_is_cta.md) |
| Short position | 空头 | Borrow and sell, buy back lower | [01](../../01_what_is_cta/01_what_is_cta.md) |
| Securities lending | 证券借贷 | The market that supplies borrowable shares to short sellers | [01](../../01_what_is_cta/01_what_is_cta.md) |
| Buy-in | 强制平仓 | Lender-protective forced close of a short | [01](../../01_what_is_cta/01_what_is_cta.md) |
| Margin | 保证金 | Collateral posted against a leveraged or short position | [01](../../01_what_is_cta/01_what_is_cta.md) |
| Information diffusion | 信息扩散 | Candidate explanation for momentum: news spreads gradually | [01](../../01_what_is_cta/01_what_is_cta.md) |
| Market maker | 做市商 | Liquidity provider with very short holding periods | [01](../../01_what_is_cta/01_what_is_cta.md) |
| Noise trader | 噪音交易者 | Uninformed order flow | [01](../../01_what_is_cta/01_what_is_cta.md) |
| OHLCV | 开高低收量 | Open, high, low, close, volume — one daily bar | [100](../../100_dataset/100_dataset.md) |
| Corporate action | 公司行为 | Split, reverse split, dividend — anything that changes the price basis | [100](../../100_dataset/100_dataset.md) |
| Forward split | 正向拆股 | One share becomes many; price divides | [100](../../100_dataset/100_dataset.md) |
| Reverse split | 反向拆股 / 并股 | Many shares become one; price multiplies | [100](../../100_dataset/100_dataset.md) |
| Back-adjustment | 复权 | Rescaling pre-event prices so the return series is continuous | [100](../../100_dataset/100_dataset.md) |
| Phantom return | 假收益 | Return produced by an unadjusted corporate action, not by the market | [100](../../100_dataset/100_dataset.md) |
| Bucketed bar chart | 分组柱状图 | Sort by signal, split into groups, plot mean forward return per group — the core signal test | [02](../../02_testing_a_signal/02_testing_a_signal.md) |
| Reversal | 反转 | Extreme recent moves partially undo themselves; strongest at high frequency | [02](../../02_testing_a_signal/02_testing_a_signal.md) |
| Skip / lag | 跳过期 | Dropping the most recent period from the lookback so reversal does not contaminate momentum | [02](../../02_testing_a_signal/02_testing_a_signal.md) |
| EWMA | 指数加权移动平均 | Moving average weighting recent observations more heavily; tuned by half-life | [03](../../03_shaping_the_lookback/03_shaping_the_lookback.md) |
| Half-life | 半衰期 | Periods after which an EWMA observation's weight has decayed by half | [03](../../03_shaping_the_lookback/03_shaping_the_lookback.md) |
| Volatility clustering | 波动率聚类 | Volatility arrives in bursts, not evenly — what makes a fast signal churn | [02](../../02_testing_a_signal/02_testing_a_signal.md) |
| Smoothing | 平滑 | Filtering the shortest cycles out of a fast signal; window must be shorter than its period | [02](../../02_testing_a_signal/02_testing_a_signal.md) |
...
| Risk-adjusted momentum | 风险调整动量 | `Avg(r/σ)` — momentum divided by volatility so values compare across assets and regimes | [02](../../02_testing_a_signal/02_testing_a_signal.md) |
| Rolling-rank bucketing | 滚动历史排序分组 | Rank a signal only against history strictly before `t`, avoiding look-ahead | [02](../../02_testing_a_signal/02_testing_a_signal.md) |
| Error bar | 误差棒 | Uncertainty of a bucket's mean; what distinguishes a real bar from a 2-sample one | [02](../../02_testing_a_signal/02_testing_a_signal.md) |
