...
> - **Prerequisites:** [02](../../02_testing_a_signal/02_testing_a_signal.md) for the bucket test, [00 · pipeline](../../00_pipeline/00_pipeline.md) for where a prediction sits in the chain.
...
here in particular: the unadjusted splits in [100](../../100_dataset/100_dataset.md) leave phantom returns near
...
Take the momentum signal from [02](../../02_testing_a_signal/02_testing_a_signal.md) and compute its rank IC series against
