...
%
% Book: a chapter heading inside the running document, plus a renumbering.
% Sections restart at 1 and print as "05.1", and the shared theorem counter
% restarts too, so Definition 3 of chapter 05 reads "Definition 05.3" and
% cannot collide with chapter 02's.
\newcommand{\chapterhead}[3]{%
  \ifbook
    \clearpage
    \phantomsection\label{chap:#3}%
    \addcontentsline{toc}{part}{#1 \midot{} #2}%
    {\Huge\bfseries #1 \midot{} #2\par}\vspace{1.5em}%
