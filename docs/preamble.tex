...
% return. 5.6in is about 77. The width goes to the margin, not to the type:
% the body stays 12pt.
\usepackage[top=1.1in, bottom=1.25in, left=1.45in, right=1.45in,
            headheight=15pt, headsep=0.28in]{geometry}
